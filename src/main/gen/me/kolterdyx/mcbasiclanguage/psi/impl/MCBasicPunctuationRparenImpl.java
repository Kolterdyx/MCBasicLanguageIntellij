...
public class MCBasicPunctuationRparenImpl extends ASTWrapperPsiElement implements MCBasicPunctuationRparen {

  public MCBasicPunctuationRparenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitPunctuationRparen(this);
  }
