...
public class MCBasicOpEqualImpl extends ASTWrapperPsiElement implements MCBasicOpEqual {

  public MCBasicOpEqualImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitOpEqual(this);
  }
