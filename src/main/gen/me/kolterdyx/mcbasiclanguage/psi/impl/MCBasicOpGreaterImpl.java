...
public class MCBasicOpGreaterImpl extends ASTWrapperPsiElement implements MCBasicOpGreater {

  public MCBasicOpGreaterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitOpGreater(this);
  }
