...
public class MCBasicPunctuationLparenImpl extends ASTWrapperPsiElement implements MCBasicPunctuationLparen {

  public MCBasicPunctuationLparenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitPunctuationLparen(this);
  }
