...
public class MCBasicPunctuationLbracketImpl extends ASTWrapperPsiElement implements MCBasicPunctuationLbracket {

  public MCBasicPunctuationLbracketImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitPunctuationLbracket(this);
  }
