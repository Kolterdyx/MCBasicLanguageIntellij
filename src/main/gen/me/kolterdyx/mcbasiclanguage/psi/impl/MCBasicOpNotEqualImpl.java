...
public class MCBasicOpNotEqualImpl extends ASTWrapperPsiElement implements MCBasicOpNotEqual {

  public MCBasicOpNotEqualImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitOpNotEqual(this);
  }
