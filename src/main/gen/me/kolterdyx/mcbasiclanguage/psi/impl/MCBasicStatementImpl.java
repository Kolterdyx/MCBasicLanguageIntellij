...
public class MCBasicStatementImpl extends ASTWrapperPsiElement implements MCBasicStatement {
  ...
  @Override
  @NotNull
  public List<MCBasicPunctuationLbrace> getPunctuationLbraceList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MCBasicPunctuationLbrace.class);
  }
  ...
  @Override
  @NotNull
  public List<MCBasicPunctuationRbrace> getPunctuationRbraceList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MCBasicPunctuationRbrace.class);
  }
  ...
  @Override
  @Nullable
  public MCBasicPunctuationSemicolon getPunctuationSemicolon() {
    return findChildByClass(MCBasicPunctuationSemicolon.class);
  }
