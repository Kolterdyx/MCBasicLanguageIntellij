...
public class MCBasicPunctuationSemicolonImpl extends ASTWrapperPsiElement implements MCBasicPunctuationSemicolon {

  public MCBasicPunctuationSemicolonImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitPunctuationSemicolon(this);
  }
