...
public class MCBasicOpLessEqualImpl extends ASTWrapperPsiElement implements MCBasicOpLessEqual {

  public MCBasicOpLessEqualImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitOpLessEqual(this);
  }
