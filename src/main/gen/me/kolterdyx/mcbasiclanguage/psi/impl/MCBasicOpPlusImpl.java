...
public class MCBasicOpPlusImpl extends ASTWrapperPsiElement implements MCBasicOpPlus {

  public MCBasicOpPlusImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitOpPlus(this);
  }
