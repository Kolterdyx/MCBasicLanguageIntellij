...
public class MCBasicOpGreaterEqualImpl extends ASTWrapperPsiElement implements MCBasicOpGreaterEqual {

  public MCBasicOpGreaterEqualImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitOpGreaterEqual(this);
  }
