...
public class MCBasicPunctuationLbraceImpl extends ASTWrapperPsiElement implements MCBasicPunctuationLbrace {

  public MCBasicPunctuationLbraceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitPunctuationLbrace(this);
  }
