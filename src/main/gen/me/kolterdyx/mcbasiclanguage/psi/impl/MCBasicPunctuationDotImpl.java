...
public class MCBasicPunctuationDotImpl extends ASTWrapperPsiElement implements MCBasicPunctuationDot {

  public MCBasicPunctuationDotImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitPunctuationDot(this);
  }
