...
public class MCBasicPunctuationRbracketImpl extends ASTWrapperPsiElement implements MCBasicPunctuationRbracket {

  public MCBasicPunctuationRbracketImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitPunctuationRbracket(this);
  }
