...
public class MCBasicPropertyImpl extends MCBasicNamedElementImpl implements MCBasicProperty {

  public MCBasicPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public String getKey() {
    return MCBasicPsiImplUtil.getKey(this);
  }

  @Override
  public String getValue() {
    return MCBasicPsiImplUtil.getValue(this);
  }
  ...
  public ItemPresentation getPresentation() {
    return MCBasicPsiImplUtil.getPresentation(this);
  }
