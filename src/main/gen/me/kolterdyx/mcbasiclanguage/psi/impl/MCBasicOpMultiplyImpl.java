...
public class MCBasicOpMultiplyImpl extends ASTWrapperPsiElement implements MCBasicOpMultiply {

  public MCBasicOpMultiplyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitOpMultiply(this);
  }
