...
public class MCBasicOpDivideImpl extends ASTWrapperPsiElement implements MCBasicOpDivide {

  public MCBasicOpDivideImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitOpDivide(this);
  }
