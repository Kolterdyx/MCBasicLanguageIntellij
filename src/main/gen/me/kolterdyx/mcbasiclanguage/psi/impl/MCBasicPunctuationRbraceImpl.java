...
public class MCBasicPunctuationRbraceImpl extends ASTWrapperPsiElement implements MCBasicPunctuationRbrace {

  public MCBasicPunctuationRbraceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitPunctuationRbrace(this);
  }
