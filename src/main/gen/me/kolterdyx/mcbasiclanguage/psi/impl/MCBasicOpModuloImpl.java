...
public class MCBasicOpModuloImpl extends ASTWrapperPsiElement implements MCBasicOpModulo {

  public MCBasicOpModuloImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MCBasicVisitor visitor) {
    visitor.visitOpModulo(this);
  }
