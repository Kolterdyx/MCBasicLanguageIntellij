...
public abstract class MCBasicNamedElementImpl extends StubBasedPsiElementBase<MCBasicNamedStubElement> implements MCBasicNamedElement {

  public MCBasicNamedElementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public MCBasicNamedElementImpl(@NotNull MCBasicNamedStubElement stub, IStubElementType<?, ?> nodeType) {
    super(stub, nodeType);
  }

  @Override
  public String getName() {
    MCBasicNamedStubElement stub = getStub();
