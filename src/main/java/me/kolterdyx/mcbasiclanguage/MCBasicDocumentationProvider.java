 ...
 */
final class MCBasicDocumentationProvider extends AbstractDocumentationProvider {

  /**
   * For the MCBasic Language, we don't have online documentation. However, if your language provides
  ...
  /**
   * Extracts the key, value, file and documentation comment of a MCBasic key/value entry and returns
   * a formatted representation of the information.
   */
  @Override
  public @Nullable String generateDoc(PsiElement element, @Nullable PsiElement originalElement) {
    if (element instanceof MCBasicProperty) {
      final String key = ((MCBasicProperty) element).getKey();
      final String value = ((MCBasicProperty) element).getValue();
      final String file = SymbolPresentationUtil.getFilePathPresentation(element.getContainingFile());
      final String docComment = MCBasicUtil.findDocumentationComment((MCBasicProperty) element);
  ...
  /**
   * Provides the information in which file the MCBasic language key/value is defined.
   */
  @Override
  ...
  /**
   * Provides documentation when a MCBasic Language element is hovered with the mouse.
   */
  @Override
